...
const debug = require('debug')('botium-connector-luis-cli')
...
yargsCmd.usage('Botium Connector LUIS CLI\n\nUsage: $0 [options]') // eslint-disable-line
  ...
  .command({
    command: 'import',
    describe: 'Downloading Convos and Utterances from LUIS App to Botium',
    builder: (yargs) => {
  ...
  .command({
    command: 'export',
    describe: 'Uploading Utterances from Botium to LUIS app',
    builder: (yargs) => {
